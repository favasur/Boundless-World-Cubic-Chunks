...
public final class MemberInfo implements ITargetSelectorRemappable, ITargetSelectorConstructor {
   ...
   public MemberInfo validate() throws InvalidMemberDescriptorException {
      if (this.owner != null) {
         ...
         if (this.unparsed != null && this.unparsed.lastIndexOf(46) > 0 && this.owner.startsWith("L")) {
            throw new InvalidMemberDescriptorException(
               "Malformed owner: "
                  + this.owner
                  + " If you are seeing this message unexpectedly and the owner appears to be correct, replace the owner descriptor with formal type L"
                  + this.owner
      ...
      if (this.name != null && !this.name.matches("(?i)^<?[\\w\\p{Sc}]+>?$")) {
         ...
         return this;
      } else if (!this.desc.matches("^(\\([\\w\\p{Sc}\\[/;]*\\))?\\[*[\\w\\p{Sc}/;]+$")) {
   ...
   public boolean equals(Object obj) {
      if (obj != null && obj instanceof ITargetSelectorByName) {
         ...
         return this.matchAll == otherMatchAll
            && this.forceField == otherForceField
   ...
   public ITargetSelectorRemappable transform(String newDesc) {
      return (newDesc != null || this.desc != null) && (newDesc == null || !newDesc.equals(this.desc))
         ? new MemberInfo(this.name, this.owner, newDesc, this.matchAll)
         : this;
   }
