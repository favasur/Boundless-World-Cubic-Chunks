...
public final class Annotations {
         ...
         if (!(value[pos] instanceof String)) {
            throw new IllegalArgumentException(
               "Annotation keys must be strings, found "
                  + value[pos].getClass().getSimpleName()
                  + " with "
                  + value[pos].toString()
                  + " at index "
                  + pos
   ...
   public static AnnotationNode getVisibleParameter(MethodNode method, Class<? extends Annotation> annotationClass, int paramIndex) {
      return paramIndex < 0
         ? getVisible(method, annotationClass)
         : getParameter(method.visibleParameterAnnotations, Type.getDescriptor(annotationClass), paramIndex);
   }
   ...
   public static AnnotationNode getInvisibleParameter(MethodNode method, Class<? extends Annotation> annotationClass, int paramIndex) {
      return paramIndex < 0
         ? getInvisible(method, annotationClass)
         : getParameter(method.invisibleParameterAnnotations, Type.getDescriptor(annotationClass), paramIndex);
   }

   public static AnnotationNode getParameter(List<AnnotationNode>[] parameterAnnotations, String annotationType, int paramIndex) {
      return parameterAnnotations != null && paramIndex >= 0 && paramIndex < parameterAnnotations.length
         ? get(parameterAnnotations[paramIndex], annotationType)
         : null;
   }
   ...
   private static Object packValue(Object value) {
      Class<? extends Object> type = (Class<? extends Object>)value.getClass();
