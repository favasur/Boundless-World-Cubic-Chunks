...
public final class VersionNumber implements Comparable<VersionNumber>, Serializable {
   ...
   public String toString() {
      ...
      return String.format(
         ...
         parts[0],
         parts[1],
         (this.value & 2147483647L) > 0L ? String.format(".%d", parts[2]) : "",
         (this.value & 32767L) > 0L ? String.format(".%d", parts[3]) : "",
         this.suffix
      );
   }
   ...
   public boolean equals(Object other) {
      return !(other instanceof VersionNumber) ? false : ((VersionNumber)other).value == this.value;
   }
   ...
   private static short[] unpack(long along) {
      return new short[]{
         (short)((int)(along >> 48)), (short)((int)(along >> 32 & 32767L)), (short)((int)(along >> 16 & 32767L)), (short)((int)(along & 32767L))
      };
   }
