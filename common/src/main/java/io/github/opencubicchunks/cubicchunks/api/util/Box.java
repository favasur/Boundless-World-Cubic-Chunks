...
/**
 * Immutable 3D integer bounding box with a mutable variant.
 * Ported from 1.12.2 Cubic Chunks.
 */
// @Original: 1.12.2:io.github.opencubicchunks.cubicchunks.api.util.Box
public class Box {
    protected int x1;
    protected int y1;
    protected int z1;
    ...
    public Box add(Box o) {
        return new Box(this.x1 + o.x1, this.y1 + o.y1, this.z1 + o.z1,
